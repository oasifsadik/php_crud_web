...
<section>
    <div class="container">
        <div class="title text-center text-primary">
            <h4 class="display-2">Edit Laptop</h4>
        </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <input type="text" name="laptop_name" value="<?php echo $row['laptop_name'];?>" class="form-control"
                        placeholder="Enter Laptop Name" require>
                </div>

                <div class="mb-3">
                    <input type="number" name="enter_laptop_qty" value="<?php echo $row['enter_laptop_qty'];?>"
                        class="form-control" placeholder="Enter Laptop Quantity" require>
                </div>
                ...
                <div class="mb-3">
                    <input type="text" name="laptop_price" value="<?php echo $row['laptop_price'];?>"
                        placeholder="Enter Laptop Price" class="form-control" require>
                </div>
